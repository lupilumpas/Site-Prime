...
const indicePopup = Math.floor(indice / 3);
const numeroPopup = indicePopup + 1;

const capas = NomesdosArquivos[indicePopup] || [];
...
const popup =
    document.getElementById(`popup-${numeroPopup}`);
...
const nomeProdutoLimpo = produtos[indicePopup].replace(/<br\s*\/?>/gi, " ");
...
const nomeProduto = produtos[indicePopup];
...
if (descricao) {
    ...
    let texto = descricaoProduto[indicePopup] || "";
...
if (preco) {
    preco.textContent = precosProdutos[indicePopup];
}
...
if (!imagem1 || !imagem2 || !imagem3 || !imagem4 || !imagem5) {
    ...
    return;
            ...
            // ==========================================
const nomesArquivo = NomesdosArquivos[indicePopup] || [];
